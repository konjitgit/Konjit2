    ...
    <>
      ...
      <div className={`${styles.section}`}>
        ...
        <div className={`${styles.section} my-4 md:ml-[150px]`}>
          <p className="text-xl sm:text-2xl font-medium uppercase">Delivery Method</p>
...
<div className="w-full  pb-3 sm:flex-row flex gap-2 ">
          ...
          <div className="sm:w-[50%]">
            ...
            >
              <option className="block pb-2 border border-gray-400 rounded-sm  w-full max-w-sm  mt-3 px-3 py-2   shadow-sm  " value="">
                Choose your City
              </option>
              {State &&
                State.getStatesOfCountry(country).map((item) => (
                  ...
                  <p
        className="text-[18px] cursor-pointer inline-block hover:text-pink"
        ...
        <div>
          ...
          <div className="flex sm:flex-row flex-col-reverse gap-4 items-center justify-between max-w-[650px]">
            ...
            <div className="mx-0">
                ...
                <button className={`${styles.button} `} onClick={paymentSubmit}>
                  Continue to Payment
                </button>
