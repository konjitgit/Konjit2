  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <>
            <Link to={`/seller-profile/${params.id}`}>
              <Button>
        ...
        return (
          <>
            <Button onClick={() => setUserId(params.id) || setOpen(true)}>
              <AiOutlineDelete size={20} className="text-red-900"/>
            </Button>
          </>
        );
      },
      ...
      <div className="w-[97%]">
        ...
        {open && (
          <div className="w-full fixed top-0 left-0 z-[999] bg-[#00000039] flex items-center justify-center h-screen">
            <div className="w-[95%] 800px:w-[40%] min-h-[20vh]  bg-beige rounded shadow p-5 fe-car">
              <div className="w-full flex justify-end cursor-pointer">
                <RxCross1 size={25} onClick={() => setOpen(false)} />
              </div>
              <h3 className="text-[25px] text-center py-5 font-bold text-[#000000cb]">
